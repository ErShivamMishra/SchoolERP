...
namespace SchoolERP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260527143421_AddParentPortalAndCardManagement")]
    partial class AddParentPortalAndCardManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolERP.Domain.Entities.GeneratedIdCard", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "TemplateId", "StudentId", "TeacherId")
                        .IsUnique()
                        .HasFilter("[StudentId] IS NOT NULL AND [TeacherId] IS NOT NULL");
